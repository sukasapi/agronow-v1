 ...
 * Created:  10.01.2009
 *
 * Description:  Modified auth system based on redux_auth with extensive customization. This is basically what Redux Auths 2 should be.
 * Original Author name has been kept but that does not mean that the method has not been modified.
 *
 * Requirements: PHP5.6 or above
 *
 * @package    CodeIgniter-Ion-Auths
 * @author     Ben Edmunds
...
class Ion_auth
{
	 ...
	 *
	 * @return int|array|bool The new user's ID if e-mail activation is disabled or Ion-Auths e-mail activation was
	...
	protected function check_compatibility()
	{
		...
		{
			show_error("Ion Auths 3 requires CodeIgniter 3. Update to CI 3 or downgrade to Ion Auths 2.");
		}

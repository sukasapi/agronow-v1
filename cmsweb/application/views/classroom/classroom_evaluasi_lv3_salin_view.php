                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Salin Evaluasi Pelatihan Lv.3 Dari Kelas Lain
                            </h3>
                        </div>
                    ...
                    <div class="kt-portlet__body">
						...
						<div class="alert alert-outline-info fade show" role="alert">
							<div class="alert-text"><small>Data evaluasi yang disalin tidak termasuk data penilai.</small></div>
						</div>

                        <div class="col-12">
							<label>ID Class Room yang Ingin Disalin *</label>
							<input type="text" class="form-control" placeholder="" required name="id_disalin" value="<?=$request['id_disalin']?>">
						</div>

                            ...
                            <div class="col-12">
                                ...
                                <div class="kt-radio-inline">
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="Type" required <?= $request['Type']=='document'? 'checked="checked"' : NULL ?> value="document"> Upload Dokumen (PDF)
                                        <span></span>
                                    </label>

                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="Type" required <?= $request['Type']=='video'? 'checked="checked"' : NULL ?> value="youtube"> Link Youtube
                                        <span></span>
                                    </label>
                                ...
                                <div id="media-holder">
                                    <?php if ($request['Type']=='video'): ?>
                                        <label class="mt-3">Link Youtube</label><input type="text" class="form-control" name="Media" value="<?= $request['Media'] ?>" required />
                                    <?php else: ?>
                                        <label class="mt-3">Dokumen</label><br>
                                        <a href="<?= URL_MEDIA_DOCUMENT.$request['Media'] ?>" target="_blank"><?= $request['Media'] ?></a>
                                        <input type="file" class="form-control mt-3" name="file" accept=".pdf" />
                                    <?php endif; ?>
                                ...
                                <script>
                                    ...
                                    $("input[name='Type']").click(function() {
                                        typeVal = this.value;
                                        if (typeVal=="document"){
                                            $('#media-holder').html('<label class="mt-3">Dokumen</label><input type="file" class="form-control" name="file" accept=".pdf" />');
                                        } else if(typeVal=="youtube"){
                                            $('#media-holder').html('<label class="mt-3">Link Youtube</label><input type="text" class="form-control" name="Media" required />');
                                ...
                                <div class="kt-radio-inline">
                                    <label class="kt-radio kt-radio--solid">
                                        ...
                                        echo set_value('Status', (isset($request['Status']))?$request['Status']:'') == 'active' ? "checked" : "checked";
                                        ?>> Active
                                        <span></span>
                                    </label>
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="Status" required value="non-active" <?php
                                        echo set_value('Status', (isset($request['Status']))?$request['Status']:'') == 'non-active' ? "checked" : "";
                                        ?>> Non-Active
                                        <span></span>
                                    </label>
                                </div>
                        ...
                        <div class="kt-form__actions kt-form__actions--solid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?php echo site_url('classroom/prelearning/').$classroom['cr_id'].'/'.$this->uri->segment(4); ?>" class="btn btn-warning pull-right pl-5 pr-5">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>

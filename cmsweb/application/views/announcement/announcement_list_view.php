...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <?php if(has_access('announcement.create',FALSE)): ?>
            <a href="<?php echo site_url("announcement/create/"); ?>" class="btn btn-brand kt-margin-l-10">
                Tambah
            </a>
            <?php endif; ?>
        </div>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table.DataTable({
                ...
                stateSave: false,
                ajax: {
                    url  : '<?php echo site_url('announcement/l_ajax').'?section_id='.$section_id.'&'.$_SERVER['QUERY_STRING']; ?>',
                    type : "POST"
                },
                language: {
                    "infoFiltered": ""
                ...
                columnDefs: [
                    ...
                    },
                    {
                        targets: 4,
                        render: function(data, type, full, meta) {
                            return '<a href="<?php echo site_url("announcement/detail/"); ?>'+full["content_id"]+'" title="View">'+data+'</a>';
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(data, type, full, meta) {
                            return '<a href="<?php echo site_url("announcement/detail/"); ?>'+full["content_id"]+'" class="btn btn-outline-primary btn-icon btn-circle btn-sm" title="View">\n' +
                                '<i class="la la-eye"></i>\n' +
                                '</a>';

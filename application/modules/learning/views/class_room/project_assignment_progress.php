            ...
            <div id="content">
                ...
                <div class="row pb-2" >
                    ...
                    <div class="col-6 col-sm-6 col-xs-6" style="max-height: 200px;">   
                        ...
                        <p class="mb-1"><strong>Nama : </strong><?=$pa[0]->nama?></p>
                                        ...
                                        <table class="table" style="border:none">
                                            <tr>
                                                ...
                                                <td rowspan="3">
                                                    ...
                                                    <input class="form-control" name="progress_outcome" id="progress_outcome" value="<?=$pa[0]->pa_progress?>">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" id="solution" name="solution" <?=$stat?> value="<?=$pa[0]->pa_solution?>"></td>
                                            
                                            </tr>
                                            <tr>
                                                <td class="txtlabel" style="vertical-align: middle;"><strong>Time Frame</strong></td>
                                                <td><input type="text" class="form-control" name="timeframe" id="timeframe" <?=$stat?> value="<?=$pa[0]->pa_timeframe?>"></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                                        ...
                                                        <?php 
                                                            foreach($detail_pa as $da){
                                                                ...
                                                                echo "<td><div class='input-group'>
                                                                        <input type='number' min='0' max='100' class='form-control taskpg' value='".$progresstask."'  data-token='".$this->encryption->encrypt($da->pad_id)."'>
                ...
                <div class="row pb-4">
                    <div class="card" style="width:100%">
                        ...
                        <div class="card-body text-center">
                        <textarea class="form-control" name="catatan" id="catatan"><?=$pa[0]->pa_catatan;?></textarea>
                        <button class="btn btn-primary btn-rounded" id="btcatatan">Simpan catatan</button>
                        </div>
                    </div>            
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#progress_outcome").on("change", function(e){
            e.preventDefault();
            var tokenpa=$("#pa_token").val();
            var val_pa=$(this).val();

            var datapa = new FormData();
            datapa.append('paid',tokenpa);
            datapa.append('progress',val_pa);
            datapa.append('act',"updateprogresspa");
            $.ajax({
        ...
        $(".taskpg").on("change",function(e){
            e.preventDefault();
            var tokenpad=$(this).data('token');
            var progress=$(this).val();

            var datapad = new FormData();
            datapad.append('token',tokenpad);
            datapad.append('progress',progress);
            datapad.append('act','updatetask')
            $.ajax({
                url: baseUrl+"" + "learning/Class_room/pa_ajax",
                type:"post",
                data:datapad,
        ...
        $("#btcatatan").on("click", function(e){
            ...
            var datapa = new FormData();
            datapa.append('paid',tokenpa);
            datapa.append('catatan',catatan);
            datapa.append('act','catatanpa');
            $.ajax({
                url: baseUrl + "learning/Class_room/pa_ajax",
                type:"post",
                data:datapa,

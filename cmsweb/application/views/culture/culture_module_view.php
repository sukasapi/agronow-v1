        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('culture/module_add/'.$culture['cr_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md">
                            ...
                            <div id="<?= $k ?>" class="kt-portlet kt-portlet--border-bottom-primary kt-portlet--collapse">
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <p class="kt-portlet__head-titles text-primary pt-3">
                                            ...
                                            <br>
                                            <small><?= isset($v['ModuleStart'])?parseDateShortReadable($v['ModuleStart']):'' ?> s/d <?= isset($v['ModuleEnd'])?parseDateShortReadable($v['ModuleEnd']):'' ?></small>
                                        </p>
                                    </div>
                                    <div class="kt-portlet__head-toolbar">
                                        <div class="kt-portlet__head-actions">
                                            <a href="<?php echo site_url('culture/module_edit/'.$culture['cr_id']).'/'.$k; ?>" class="btn btn-clean btn-sm  btn-icon-md">
                                                <i class="flaticon2-edit"></i> Edit Modul
                                            </a>

                                            <a href="<?php echo site_url('culture/module_delete/'.$culture['cr_id']).'/'.$k; ?>" class="btn btn-clean btn-sm  btn-icon-md" onclick="return confirm('Anda yakin menghapus Modul?')">
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover nowrap" id="kt_table">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo site_url('culture/module_materi/'.$culture['cr_id']).'/'.$k; ?>" class="">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo site_url('culture/module_evaluasi/'.$culture['cr_id']).'/'.$k; ?>" class="">
                                    ...
                                    <span class="badge badge-<?= isset($v['Evaluasi']['Status'])&& $v['Evaluasi']['Status'] =='active'?'success':'warning' ?> badge-pill">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo site_url('culture/module_feedback/'.$culture['cr_id']).'/'.$k; ?>" class="">
                ...
                <?php if (isset($request['Module'])): ?>
                    ...
                    <br><br>
                    <form action="<?php echo site_url('culture/module_update_tree/'.$culture['cr_id']); ?>" method="post" accept-charset="utf-8">
        ...
        $('.remove-module').click(function(){
            ...
            if (confirmalert == true) {
                ...
                $.ajax({
                    url: 'remove.php',
                    type: 'POST',
                    data: { cr_id:cultureId , crs_id:moduleId },

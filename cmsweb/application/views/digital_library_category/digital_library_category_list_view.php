...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <?php if(has_access('digitallibrarycat.create',FALSE)): ?>
            <a href="<?php echo site_url("digital_library_category/create/"); ?>" class="btn btn-brand kt-margin-l-10">
                Tambah
            </a>
            <?php endif; ?>
        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="list-group">
                                        ...
                                        <?php foreach (getKlienAll() as $k => $v): ?>
                                            ...
                                            <a href="<?php echo site_url('digital_library_category?id_klien=').$v['id']; ?>" class="list-group-item list-group-item-action <?php echo ($this->input->get('id_klien')==$v['id'])?'active':NULL; ?>"><?= $v['nama'] ?></a>
            ...
            <div class="col-lg-<?= my_klien()?'12':'8' ?>">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__body">
                        ...
                        <form action="<?php echo site_url('digital_library_category/update_tree'); ?>" method="post" accept-charset="utf-8">

                            <?php if(has_access('digitallibrarycat.edit',FALSE)): ?>
                                        ...
                                        <?php if (!empty($list)): ?>
                                            <?php foreach($list as $item): ?>
                                                ...
                                                <?php endif; ?>
                                                            ...
                                                            <?php endif; ?>
                                                <!--<a class="mr-3" href="<?php /*echo site_url('digital_library_category/create').'?parent='.$item['cat_id']; */?>" title="add child">
                                                    <i class="fa fa-plus"></i>
                                                </a>-->
                                                <a class="mr-3  <?= has_access("digitallibrarycat.edit",FALSE)?"":"d-none" ?>" href="<?php echo site_url('digital_library_category/edit_picture/').$item['cat_id']; ?>" title="Edit Gambar">
                                                    <i class="la la-picture-o"></i>
                                                </a>
                                                <a class="mr-3  <?= has_access("digitallibrarycat.edit",FALSE)?"":"d-none" ?>" href="<?php echo site_url('digital_library_category/edit/').$item['cat_id']; ?>" title="edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a class="text-danger  <?= has_access("digitallibrarycat.delete",FALSE)?"":"d-none" ?>" href="<?php echo site_url('digital_library_category/delete/').$item['cat_id']; ?>" title="delete">

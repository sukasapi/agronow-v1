...
<div id="appCapsule">
    <div class="section full mb-5">
        <?php if($ulang != '1' && $dataStep['MP'][$module]['EvaStatus'] == '2' && strtotime($dataMp['Module'][$module]['ModuleStart']) <= strtotime(date('Ymd'))){ ?>
            ...
            ?>
        <?php }else{
            if ($attempt == 0) redirect(base_url('learning/class_room/home?cr_id='.$data['cr_id']));
            ?>
            ...
            <div id="divSoal" class="m-2 my-0">
                ...
                <?php }else{?>
                    <form action="<?= base_url('learning/class_room/evaluasi?cr_id='.$data['cr_id'].'&module='.$module) ?>" id="form" method="post" class="form-horizontal">
                            ...
                            <div class="text-center">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-6 col-sm-6 pull-right" align="right">
                                        ...
                                        <button type="submit" name="sendAnswerEvaluasi" id="sendAnswerEvaluasi" class="btn btn-success" value="1">
                                            <span>SUBMIT</span>&nbsp;&nbsp;
                                            <span class="btn-label"><i class="fa fa-arrow-right"></i></span>
                                        </button>
                                    </div>

...
<div id="appCapsule">
    <div class="section full mb-5">
		...
		<?php if (!isset($dataMp['Module'][$module]['Materi'][$materi]['Status']) || $dataMp['Module'][$module]['Materi'][$materi]['Status'] == 'active'): ?>
        <div class="m-2">
            ...
            <?php }else{ ?>
                ...
                ?>
                <a href="<?=base_url('learning/class_room/materi_doc').'?cr_id='.$data['cr_id'].'&doc='.base64_encode($media_url).'&type=MP&materi='.$materi;?>" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> &nbsp; Baca Materi </a>
		...
		<div class="m-2 text-center">
			<span class="h5">Materi tidak aktif, silahkan lanjutkan ke materi berikutnya.</span>
		</div>
		<?php endif; ?>
        <div class="m-2 mt-3 mb-3">
            <a href="<?=base_url('learning/class_room/module?cr_id='.$data['cr_id']);?>" type="button" class="btn btn-block btn-lg btn-success">MODUL PELATIHAN</a>
        </div>
    </div>
</div>
<!-- * App Capsule -->

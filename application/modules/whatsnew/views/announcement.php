...
<div class="extraHeader">
    <?php echo form_open('whatsnew/announcement/search', ['class'=>'search-form']); ?>
...
<div id="appCapsule" class="extra-header-active full-height">
    ...
    <?php foreach($data as $d): ?>
        <li>
            <a href="<?=base_url("whatsnew/announcement/detail/".$d['id'])?>" class="item">
    ...
    <div class="pt-2 pb-2">
        <nav>
            <ul class="pagination pagination-rounded">
                <?php if($page > 1): ?>
                    <li class="page-item"><a class="page-link" href="<?=base_url("whatsnew/announcement/index/".($page-1))?>">Previous</a></li>
                <?php endif ?>
                <?php if(count($data)>9): ?>
                <li class="page-item"><a class="page-link" href="<?=base_url("whatsnew/announcement/index/".($page+1))?>">Next</a></li>
                <?php endif; ?>
            </ul>
        </nav>
    </div>

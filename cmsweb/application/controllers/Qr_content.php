...
class Qr_content extends CI_Controller {
    ...
    function index(){
        has_access('qrcontent.view');

        $data['section_id']     = $this->section_id;
        $data['page_name']          = 'QR Content';
        $data['page_sub_name']      = 'List QR Content';
        $data['is_content_header']  = TRUE;
        $data['page']               = 'qr_content/qr_content_list_view';
    ...
    function detail($content_id=NULL){
        ...
        $data['page'] = 'qr_content/qr_content_detail_view';
        $data['submenu'] = 'qr_content/qr_content_detail_submenu_view';
        $this->load->view('main_view',$data);
    }

    function create(){
        has_access('qrcontent.create');

        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('qr_content');
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['form_action']    = site_url('qr_content/create');
            $data['page']           = 'qr_content/qr_content_form_create_view';
            ...
            if ($insert==TRUE) {
                ...
                $url_return = site_url('qr_content/detail/').$insert;
            }else{
    ...
    function edit_content($content_id=NULL){
        ...
        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('qr_content/detail/').$content_id;
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('qr_content/edit_content').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "QR Content";
            $data['page_sub_name']      = 'Edit Konten'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'qr_content/qr_content_form_edit_content_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_picture($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('qr_content/edit_picture').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "QR Content";
            $data['page_sub_name']      = 'Edit Gambar'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'qr_content/qr_content_form_edit_picture_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_publish($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('qr_content/edit_publish').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "QR Content";
            $data['page_sub_name']      = 'Edit Status'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'qr_content/qr_content_form_edit_publish_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_metadata($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('qr_content/edit_metadata').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "QR Content";
            $data['page_sub_name']      = 'Edit Metadata'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'qr_content/qr_content_form_edit_metadata_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function delete($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['request']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('qr_content/delete').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "QR Content";
            $data['page_sub_name']      = 'Hapus QR Content';
            $data['page']               = 'qr_content/qr_content_form_delete_view';
            $this->load->view('main_view',$data);
        }else{
            ...
            if ($delete==TRUE) {
                ...
                $url_return = site_url('qr_content/delete/'.$content_id);

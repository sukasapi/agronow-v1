            ...
            <div class="col-lg-8">
                ...
                <div class="kt-portlet" data-ktportlet="true">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <input type="hidden" name="expert_id" value="<?php echo $request['expert_id']; ?>" />

                                <label>Judul <span class="required" aria-required="true"> * </span></label>
                                <input type="text" class="form-control" placeholder="" name="expert_name" required value="<?php
                                if (validation_errors()) {echo set_value('expert_name');}else{echo isset($request) ? htmlentities($request['expert_name'], ENT_QUOTES) : '';} ?>">
                                ...
                                <textarea id="content" name="expert_desc" style="min-height: 500px" class="form-control"><?php
                                    if (validation_errors()) {echo set_value('expert_desc');}else{echo isset($request) ? htmlentities($request['expert_desc'], ENT_QUOTES) : '';} ?></textarea>
                            ...
                            <div class="col-12">
                                ...
                                <div class="kt-radio-inline">
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="expert_sticky" required checked="" value="0" <?php
                                        echo set_value('expert_sticky', ($editable)?$request['expert_sticky']:'') == '0' ? "checked" : "checked";
                                        ?>> General
                                        <span></span>
                                    </label>
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="expert_sticky" required value="1" <?php
                                        echo set_value('expert_sticky', ($editable)?$request['expert_sticky']:'') == '1' ? "checked" : "";
                                        ?>> Sticky
                                        <span></span>
                                    </label>
                                </div>
    ...
    var Select2 = {
        init: function() {
            ...
            $("#select2_cat").select2({
                ...
                multiple: false,
                ajax: {
                    url: "<?php echo site_url('expert_category/ajax_search'); ?>",
                    dataType: "json",
                    delay: 50,

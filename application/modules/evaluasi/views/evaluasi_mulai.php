...
<div id="appCapsule">
    <div class="section full mb-5">
       ...
       <div class=" py-4 my-2 px-2">
        <div class="card">
            <h3 class="text-center m-2">EVALUASI <?=strtoupper($setsoal[0]->jenis)?> <br>KELAS <?=$kelas[0]->cr_name?></h3>
...
<script>
   $( document ).ready(function() {
    var url='<?=base_url('evaluasi/')?>';
    var urlback='<?=base_url('evaluasi')?>';
    var urllist='<?=base_url('evaluasi/profil_add')?>';
    ...
    const surveyJson = {
            ...
            pages: dgrab,
            completedHtml: "Terima kasih atas Feedback Anda.<br> <a class='btn btn-rounded btn-primary' href='"+urlback+"'>Keluar</a>  <a class='btn btn-rounded btn-warning' href='"+urllist+"'>Kembali</a>",
    }

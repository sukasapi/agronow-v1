                            ...
                            <div class="kt-portlet__head-actions">
                                ...
                                <script>
                                    $(document).on('click', '.picker-digital-library', function () {
                                        ...
                                        $.post("<?= site_url('culture/module_materi_add_digital_library/'.$culture['cr_id'].'/'.$module_id); ?>", {id: id}, function(result){
                                ...
                                <a href="<?= site_url('culture/module_materi_add/').$culture['cr_id'].'/'.$this->uri->segment(4) ?>" class="btn btn-outline-info btn-sm">Tambah Materi</a>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="table-responsive">
                                    ...
                                    <?php foreach ($request['Materi'] as $k => $v): ?>
                                        <tr id="<?= $k ?>">
                                            ...
                                            <td class="text-center">
                                                <a href="<?= site_url('culture/module_materi_delete/').$culture['cr_id'].'/'.$this->uri->segment(4).'/'.$k ?>" class="btn btn-outline-danger btn-icon btn-circle btn-sm"  onclick="return confirm('Anda yakin menghapus Modul?')" title="Hapus">
                            ...
                            <?php if (isset($request['Materi'])): ?>
                                ...
                                <br><br>
                                <form action="<?php echo site_url('culture/module_materi_update_tree/'.$culture['cr_id'].'/'.$module_id); ?>" method="post" accept-charset="utf-8">

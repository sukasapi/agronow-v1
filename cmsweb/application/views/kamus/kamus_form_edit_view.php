                    ...
                    <input autocomplete="false" name="hidden" type="text" style="display:none;">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <input type="hidden" name="kamus_id" value="<?php echo $request['kamus_id']; ?>" />

                                <div class="col-lg-6">
                                    <label>Istilah *</label>
                                    <input type="text" class="form-control kt-input" placeholder="" name="kamus_name" required value="<?php
                                    ...
                                    <input type="text" class="form-control kt-input" placeholder="" name="kamus_desc" required value="<?php

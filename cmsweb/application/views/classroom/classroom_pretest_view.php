                        ...
                        <div class="kt-form__actions kt-form__actions--solid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?php echo site_url('classroom/pretest/').$classroom['cr_id']; ?>" class="btn btn-warning pull-right pl-5 pr-5">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <?php $no=0; foreach ($soal as $k => $v): ?>
                                        <tr id="soal-<?php echo $v['crs_id']; ?>">
                                            ...
                                            <td class="text-center">
                                                <a title="Remove" href="<?= site_url('classroom/pretest_remove_soal/'.$classroom['cr_id'].'/'.$v['crs_id']); ?>" class="remove-soal btn text-danger <?= is_classroom_editable($classroom['cr_id'])?'':'d-none' ?>" onclick="return confirm('Anda yakin?')" data-classroom-id="<?= $classroom['cr_id']; ?>" data-soal-id="<?= $v['crs_id']; ?>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>

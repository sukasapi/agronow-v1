...
<div class="appHeader text-light" style="background: url('<?=PATH_ASSETS?>icon/login_bg.png'); background-repeat: no-repeat; background-size: 100%; border-top: 0px;">
    ...
    <div class="pageTitle">ADD BOD SHARE</div>
</div>
<!-- * App Header -->
...
<div id="appCapsule" class="demoPage">
    <div class="section full mt-2 mb-2 ml-2 mr-2">
        <div class="wide-block pt-2 pb-2">
            <form action="<?=base_url('whatsnew/bod_share/add')?>" autocomplete="off" class="needs-validation" novalidate enctype="multipart/form-data" method="post" accept-charset="utf-8">
                <div class="form-group boxed">
                    <div class="input-wrapper">
                        <label class="label">Topik</label>
                        <input type="text" name="content_name" class="form-control" placeholder="" required>
                        <i class="clear-input">
                ...
                <div class="form-group boxed">
                    <div class="input-wrapper">
                        ...
                        <textarea id="keterangan" name="content_desc" rows="2" class="form-control" required></textarea>
                        <i class="clear-input">
                            <ion-icon name="close-circle"></ion-icon>
                        </i>
                        <div class="valid-feedback">OK!</div>
                    ...
                    <div class="input-wrapper">
                        ...
                        <div class="d-flex justify-content-start mt-2">
                            <div class="custom-control custom-radio mr-1">
                                <input type="radio" id="customRadio1" name="content_status" value="draft" class="custom-control-input" required>
                                <label class="custom-control-label" for="customRadio1">DRAFT</label>
                                <div class="valid-feedback">&nbsp;</div>
                                <div class="invalid-feedback">Kolom ini tidak boleh kosong!</div>
                            </div>
                            <div class="custom-control custom-radio ml-1">
                                <input type="radio" id="customRadio2" name="content_status" value="publish" class="custom-control-input">

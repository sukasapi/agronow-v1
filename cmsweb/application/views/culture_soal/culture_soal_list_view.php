...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <?php if(has_access('culturesoal.create',FALSE)): ?>
            <a href="<?php echo site_url("culture_soal/create/"); ?>" class="btn btn-brand kt-margin-l-10">
                Tambah
            </a>
            <?php endif; ?>
        </div>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table.DataTable({
                ...
                stateSave: false,
                ajax: {
                    url  : '<?php echo site_url('culture_soal/l_ajax').'?'.$_SERVER['QUERY_STRING']; ?>',
                    type : "POST"
                },
                language: {
                    "infoFiltered": ""
                ...
                columnDefs: [

                    {
                        ...
                        render: function(data, type, full, meta) {
                            return '<a href="<?php echo site_url("culture_soal/edit/"); ?>'+full["crs_id"]+'" class="btn btn-outline-info btn-icon btn-circle btn-sm  <?= has_access("culturesoal.edit",FALSE)?"":"d-none" ?>" title="Edit">\n' +
                                '<i class="la la-pencil"></i>\n' +
                                '</a>\n' +

                                '<a href="<?php echo site_url("culture_soal/delete/"); ?>'+full["crs_id"]+'" class="ml-1 btn btn-outline-danger btn-icon btn-circle btn-sm  <?= has_access("culturesoal.delete",FALSE)?"":"d-none" ?>" title="Hapus">\n' +

                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="password" class="form-control" placeholder="" name="member_password" required value="">

                                <label class="mt-3">Konfirmasi Password *</label>
                                <input type="password" class="form-control" placeholder="" name="member_password_confirm" required value="">

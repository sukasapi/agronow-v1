                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" placeholder="" name="user_email" required value="<?php
                                if (validation_errors()) {echo set_value('user_email');}else{echo isset($request) ? htmlentities($request['user_email'], ENT_QUOTES) : '';} ?>">

                                <input type="hidden" class="form-control" placeholder="" name="current_user_email" value="<?php echo $request['user_email'] ?>">

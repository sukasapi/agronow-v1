    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url("learning_room"); ?>" class="btn kt-subheader__btn-primary">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('learning_room/edit_content/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('knowledge_sharing/edit_document/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md">
                                    <i class="flaticon2-edit"></i> Edit
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                <iframe src="<?php echo URL_MEDIA_DOCUMENT.$document_value; ?>" style="width:100%; height:500px;" frameborder="0"></iframe>
                            </div>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('learning_room/edit_seo/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md">
                                    <i class="flaticon2-edit"></i> Edit
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('learning_room/edit_picture/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md">
                                    <i class="flaticon2-edit"></i> Edit
                                </a>
                            </div>
                        </div>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('learning_room/edit_publish/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md">
                                    <i class="flaticon2-edit"></i> Edit
                                </a>
                            </div>
                        </div>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('learning_room/edit_metadata/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md">
                                    <i class="flaticon2-edit"></i> Edit
                                </a>
                            </div>
                        </div>

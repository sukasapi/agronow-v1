                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <input type="hidden" name="pelatihan_id" value="<?php echo $request['pelatihan_id']; ?>" />

                            <div class="col-lg-6">

                                <p style="font-size:18px">Anda yakin ingin menghapus <b><?php echo $request['pelatihan_name']; ?></b>?</p>

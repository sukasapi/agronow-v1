                            ...
                            <div class="col-12">
                                ...
                                <div class="kt-radio-inline">
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="Type" required checked="checked" value="document"> Upload Dokumen
                                        <span></span>
                                    </label>
                                ...
                                <div id="media-holder">
                                    <label class="mt-3">Dokumen</label><input type="file" class="form-control" name="file" accept=".xlsx,.xls,.doc, .docx,.ppt, .pptx,.txt,.pdf" required />
                                </div>
                                ...
                                <script>
                                    ...
                                    $("input[name='Type']").click(function() {
                                        typeVal = this.value;
                                        if (typeVal=="document"){
                                            $('#media-holder').html('<label class="mt-3">Dokumen</label><input type="file" class="form-control" name="file" accept=".xlsx,.xls,.doc, .docx,.ppt, .pptx,.txt,.pdf" required />');
                        ...
                        <div class="kt-form__actions kt-form__actions--solid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?php echo site_url('culture/module_materi/').$culture['cr_id'].'/'.$this->uri->segment(4); ?>" class="btn btn-warning pull-right pl-5 pr-5">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>

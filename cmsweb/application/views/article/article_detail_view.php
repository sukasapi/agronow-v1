    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url("article"); ?>" class="btn kt-subheader__btn-primary">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('article/edit_content/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md <?= has_access('article.edit',FALSE)?'':'d-none' ?>">
            ...
            <div class="col-lg-4">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('article/edit_picture/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md <?= has_access('article.edit',FALSE)?'':'d-none' ?>">
                                    <i class="flaticon2-edit"></i> Edit
                                </a>
                            </div>
                        </div>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('article/edit_publish/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md <?= has_access('article.edit',FALSE)?'':'d-none' ?>">
                                    <i class="flaticon2-edit"></i> Edit
                                </a>
                            </div>
                        </div>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('article/edit_metadata/'.$content['content_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md <?= has_access('article.edit',FALSE)?'':'d-none' ?>">
                                    <i class="flaticon2-edit"></i> Edit
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <center>
                                    <a href="<?php echo site_url('article/notif/'.$content['content_id']); ?>" class="btn btn-success btn-sm  btn-icon-md">
                ...
                <div class="kt-portlet <?= has_access("article.delete",FALSE)?"":"d-none" ?>">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title text-primary">
                                Hapus Konten
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <center>
                                    <a href="<?php echo site_url('article/delete/'.$content['content_id']); ?>" class="btn btn-danger btn-sm  btn-icon-md">

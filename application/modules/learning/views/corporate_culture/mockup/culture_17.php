...
<div id="appCapsule">
    ...
    <div class="section full p-2 mb-2">
        ...
        <div class="d-flex m-1" style="color: white">
            ...
            <div class="p-1" style="background-color: #0f7695"><ion-icon name="checkmark-outline"></ion-icon></div>
        </div>
        <div class="d-flex m-1" style="color: white">
            <div class="p-1" style="background-color: #399d16">2</div>
            <div class="p-1 flex-grow-1" style="background-color: #69b344">
                COMPETENCY TEST
                <p class="m-0" style="font-size: x-small;">Waktu: 24 Jan 2020 00:00 - 31 Jan 2020 00:00</p>
            </div>
            <div class="p-1" style="background-color: #399d16"><ion-icon name="checkmark-outline"></ion-icon></div>
        </div>
        <div class="d-flex m-1" style="color: white">
            <div class="p-1" style="background-color: #399d16">3</div>
            <div class="p-1 flex-grow-1" style="background-color: #69b344">REPORT</div>
            <div class="p-1" style="background-color: #399d16"><ion-icon name="checkmark-outline"></ion-icon></div>
        </div>

...
class Forum_group_model extends CI_Model {
    ...
    var $column_order = array('_forum_group.forum_id','_forum_group.forum_name','_member.member_name','_forum_group.forum_name','_forum_group.forum_create_date','_forum_group.forum_update_date',NULL,NULL); //set column field database for datatable orderable
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->select('_forum_group.*,_member.member_name,_group.group_id,_group.group_name');
    ...
    function search($q,$limit=NULL){
        ...
        parent.forum_number as parentforum_number');
        $this->db->from('_forum_group');

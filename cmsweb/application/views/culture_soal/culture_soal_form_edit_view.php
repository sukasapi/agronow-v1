    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url("culture_soal"); ?>" class="btn kt-subheader__btn-primary">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" placeholder="" name="crs_question" required value="<?php
                                if (validation_errors()) {echo set_value('crs_question');}else{echo isset($request) ? htmlentities($request['crs_question'], ENT_QUOTES) : '';} ?>">

                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="kt-radio-inline">
                            <label class="kt-radio kt-radio--solid">
                                ...
                                echo set_value('Model', $request['Model'] == 'multiple-choice' ? "checked" : "");
                                ?>> MULTIPLE CHOICE
                                <span></span>
                            </label>
                            <label class="kt-radio kt-radio--solid">
                                <input type="radio" name="Model" required value="essay" <?php
                                echo set_value('Model', $request['Model'] == 'essay' ? "checked" : "");
                                ?>> ESSAY
                                <span></span>
                            </label>
                        </div>
                        ...
                        <script>
                            $(document).ready(function(){
                                <?php
                                    if ($request['Model'] == 'multiple-choice'){
                                        echo "$('#holder-multiple-choice').show();";
                                    }

                                if ($request['Type']=='text'){
                                    echo "$('.input-text').show();$('.input-holder-image').hide();";
                                }else if($request['Type']=='image'){
                                    echo "$('.input-text').hide();$('.input-holder-image').show();";
                                }else if($request['Type']=='text-image'){
                                    echo "$('.input-text').show();$('.input-holder-image').show();";
                                }
                                ?>
                        ...
                        <div id="holder-multiple-choice" style="display: none;">
                            ...
                            <div class="kt-radio-inline">
                                <label class="kt-radio kt-radio--solid">
                                    ...
                                    echo set_value('Type', $request['Type'] == 'text' ? "checked" : "");
                                    ?>> TEXT
                                    <span></span>
                                </label>
                                <label class="kt-radio kt-radio--solid">
                                    <input type="radio" name="Type" value="image" <?php
                                    echo set_value('Type', $request['Type'] == 'image' ? "checked" : "");
                                    ?>> IMAGE
                                    <span></span>
                                </label>
                                <label class="kt-radio kt-radio--solid">
                                    <input type="radio" name="Type" value="text-image" <?php
                                    echo set_value('Type', $request['Type'] == 'text-image' ? "checked" : "");
                                    ?>> TEXT & IMAGE
                                    <span></span>
                                </label>
                            </div>
                            ...
                            <div class="choice">
                                ...
                                <div class="row input-holder-image">
                                    ...
                                    <div class="col-3">
                                        <img width="100px" src="<?= isset($request['ChoiceImage'][0])?URL_MEDIA_IMAGE.$request['ChoiceImage'][0]:'' ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="choice">
                                ...
                                <div class="row input-holder-image">
                                    ...
                                    <div class="col-3">
                                        <img width="100px" src="<?= isset($request['ChoiceImage'][1])?URL_MEDIA_IMAGE.$request['ChoiceImage'][1]:'' ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="choice">
                                ...
                                <div class="row input-holder-image">
                                    ...
                                    <div class="col-3">
                                        <img width="100px" src="<?= isset($request['ChoiceImage'][2])?URL_MEDIA_IMAGE.$request['ChoiceImage'][2]:'' ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="choice">
                                ...
                                <div class="row input-holder-image">
                                    ...
                                    <div class="col-3">
                                        <img width="100px" src="<?= isset($request['ChoiceImage'][3])?URL_MEDIA_IMAGE.$request['ChoiceImage'][3]:'' ?>">
                                    </div>
                                </div>
                            </div>

               ...
               if($posteval==TRUE){
                ...
                if(isset($post['ev_narsum']) && $post['ev_narsum'] != "0"){
                     foreach($post['narsum'] as $n){
                        ...
                        //edit 04042024
                        $setsoal=$this->ce->set_soalbyType("narasumber",$jenis);
                        $dataupdate=array("cr_id"=>$cr_id,"jenis"=>"narasumber","status"=>"0","setsoal"=>$setsoal,"tipe"=>$jenis); 
                        $updateevaluasi=$this->ce->edit_setsoal($dataupdate);
   ...
   //----------------------//
    ...
    function test_result(){
        ...
        if($_POST){
            ...
            //tambahan
            $data['feedback']=$this->classroom_model->get_feedback($filter);

            ...
            <div class="col-lg-8">
                ...
                <div class="kt-portlet" data-ktportlet="true">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <input type="hidden" name="forum_id" value="<?php echo $request['forum_id']; ?>" />
                                ...
                                $attr = 'id="group_id" class="form-control" id="select2_group-"';
                                ...
                                $attr = 'id="cat_id" class="form-control" id="select2_cat-"';
                                ...
                                <script>
                                    $('#group_id').change(function(){
                                        ...
                                        $.ajax({
                                            type: "GET",
                                            url: "<?= site_url('forum_group/ajax_category_get_by_group/') ?>"+id,
                                            success: function( data ) {
                                                ...
                                                $.each(data, function(i, item) {
                                                    $('#cat_id').append($('<option>', {value:i, text:item}));
                                                });
                                            }
                                        });
                                    });

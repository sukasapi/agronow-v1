                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <textarea name="Question" style="min-height: 100px" required class="form-control"><?php
                            if (validation_errors()) {echo set_value('Question');}else{echo isset($request['Question'][$index]) ? htmlentities($request['Question'][$index], ENT_QUOTES) : '';} ?></textarea>

                        <label class="mt-3">Type *</label>
                        <div class="kt-radio-inline">
                            <label class="kt-radio kt-radio--solid">
                                <input type="radio" name="Type" required value="pilihan" <?php
                                echo set_value('Type', $request['Type'][$index] == 'pilihan' ? "checked" : "");
                                ?>> PILIHAN
                                <span></span>
                            </label>
                            <label class="kt-radio kt-radio--solid">
                                <input type="radio" name="Type" required value="text" <?php
                                echo set_value('Type', $request['Type'][$index] == 'text' ? "checked" : "");
                                ?>> TEXT
                                <span></span>
                            </label>
                        </div>

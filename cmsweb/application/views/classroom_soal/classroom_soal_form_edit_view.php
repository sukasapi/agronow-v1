    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url("classroom_soal"); ?>" class="btn kt-subheader__btn-primary">
            ...
            <div class="col-lg-8">
                ...
                <div class="kt-portlet kt-portlet--head-sm" data-ktportlet="true">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <input type="hidden" name="crs_id" value="<?php echo $request['crs_id']; ?>" />
                                ...
                                <textarea class="form-control" placeholder="" name="crs_question" rows="5" required><?php                                if (validation_errors()) {echo set_value('crs_question');}else{echo isset($request) ? htmlentities($request['crs_question'], ENT_QUOTES) : '';} ?></textarea>

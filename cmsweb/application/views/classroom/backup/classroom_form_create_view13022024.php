                        ...
                        <div class="row">
							<div class="col-12 mb-2">
                                ...
                                <select class="form-control kt-input" name="cr_kelola" id="cr_kelola" required>
									...
									<option value="luar_app">dikelola di di luar AgroNow (Non AgroWallet)</option>
                                </select>
							</div>
                            ...
                            <div class="col-12">
                               ...
                               /* if (validation_errors()) {$val = set_value('cat_id');}else{$val = isset($request) ? htmlentities($request['cat_id'], ENT_QUOTES) : NULL;}
                                ...
                                <input type="text" class="form-control" placeholder="" name="cr_name" id="cr_name" required value="<?php
							...
							<div id="det_ui" class="col-12">
                                ...
                                <div class="kt-radio-inline">
                                    ...
                                    <label class="kt-radio kt-radio--solid">
                                        ...
                                        echo set_value('cr_modul_harus_urut', ($editable)?$request['cr_modul_harus_urut']:'') == '0' ? "checked" : "checked";
                                        ?>> Tidak
                                        <span></span>
                                    </label>
                                </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="row mb-4">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="kt-radio-inline">
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="ev_external" required checked="" value="1" > Ya
                                        <span></span>
                                    </label>
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="ev_external" required checked="" value="0" > Tidak
                                        <span></span>
                                    </label>
                                </div>
                                </div>

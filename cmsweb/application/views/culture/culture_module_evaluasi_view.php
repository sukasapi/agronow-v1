                                    ...
                                    <?php $no=0; foreach ($soal as $k => $v): ?>
                                        <tr id="soal-<?php echo $v['crs_id']; ?>">
                                            ...
                                            <td class="text-center">
                                                <a title="Remove" href="<?= site_url('culture/module_evaluasi_remove_soal/'.$culture['cr_id'].'/'.$this->uri->segment(4).'/'.$v['crs_id']); ?>" class="remove-soal btn text-danger" onclick="return confirm('Anda yakin?')" data-culture-id="<?= $culture['cr_id']; ?>" data-soal-id="<?= $v['crs_id']; ?>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>

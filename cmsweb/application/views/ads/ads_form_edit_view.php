    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url("ads/detail/".$ads['ads_id']); ?>" class="btn kt-subheader__btn-primary">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <div class="kt-checkbox-list">
                                            <?php
                                            $arr_value = getKlienBySectionData($ads['section_id'],$ads['ads_id'],'content');
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" placeholder="" name="ads_link" required value="<?php
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control date-picker" placeholder="dd/mm/yyyy" name="ads_start" value="<?php
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control date-picker" placeholder="dd/mm/yyyy" name="ads_end" value="<?php

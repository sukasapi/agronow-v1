...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="la la-file kv-caption-icon"></i>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="la la-trash text-danger"></i>',
                    removeClass: 'btn btn-xs btn-default',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="la la-upload text-info"></i>',
                    uploadClass: 'btn btn-xs btn-default',
                    uploadTitle: 'Upload file',
                    zoomIcon: '<i class="la la-search"></i>',
                    zoomClass: 'btn btn-xs btn-default',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="la la-menu-hamburger"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="la la-hand-down text-warning"></i>',
                    indicatorSuccess: '<i class="la la-ok-sign text-success"></i>',
                    indicatorError: '<i class="la la-exclamation-sign text-danger"></i>',
                    indicatorLoading: '<i class="la la-hand-up text-muted"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="la la-triangle-left"></i>',
            next: '<i class="la la-triangle-right"></i>',
            toggleheader: '<i class="la la-resize-vertical"></i>',
            fullscreen: '<i class="la la-fullscreen"></i>',
            borderless: '<i class="la la-resize-full"></i>',
        ...
        cancelIcon: '<i class="la la-ban-circle"></i>',
        ...
        msgValidationErrorIcon: '<i class="la la-exclamation-sign"></i> ',

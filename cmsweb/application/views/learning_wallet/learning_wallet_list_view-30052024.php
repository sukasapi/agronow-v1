...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
			...
			<?php if(has_access('learningwallet.tambah_kelas_agrowallet',FALSE)): ?>
            <a href="<?php echo base_url("learning_wallet/tambah_kelas_agrowallet"); ?>" class="btn btn-brand kt-margin-l-10">
                Tambah
            </a>
			<?php endif; ?>
        </div>
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
							return rupiah.format(full['harga']);
                        },
                    },
					{
                        targets: -1,
                        ...
                        orderable: false,
                        render: function(data, type, full, meta) {
							<?php if(has_access('learningwallet.edit_kelas_agrowallet',FALSE)): ?>

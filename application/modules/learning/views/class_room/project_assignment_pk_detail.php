                ...
                <div class="text-center pb-4">
                    ...
                    <?php $pa[0]->pa_status =="open" || $pa[0]->pa_status =="draft" ? $stat="":$stat="readonly"; ?>
                        ...
                        <?php 
                            ...
                            if(!isset($pa[0]->pa_status)){
                                ?>
                                <span class="badge badge-pill badge-danger">Belum Input</span>
                                
                                <?php
                            }
                            else if( $pa[0]->pa_status =="draft"){
                                ?>
                                <span class="badge badge-pill badge-primary">Draft</span>
                                
                                <?php
                            }else if($pa[0]->pa_status =="open"){
                                ?><span class="badge badge-pill badge-primary">Open</span>
                                <?php
                            }
                            else if($pa[0]->pa_status =="progress"){
                                ?><span class="badge badge-pill badge-success">final/scoring</span>
                                <?php
                            }
                            else{
                                ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" style="border:none">
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" readonly  id="problem"name="problem" <?=$stat?> value="<?=$pa[0]->pa_problem?>"></td>
                                                <td rowspan="3">
                                                    <label for="progress_outcome">% Progress Outcome</label>
                                                    <input class="form-control" readonly name="progress_outcome" id="progress_outcome" value="<?=$pa[0]->pa_progress?>">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" readonly id="solution" name="solution" <?=$stat?> value="<?=$pa[0]->pa_solution?>"></td>
                                            
                                            </tr>
                                            <tr>
                                                <td class="txtlabel" style="vertical-align: middle;"><strong>Time Frame</strong></td>
                                                <td><input type="text" class="form-control" readonly name="timeframe" id="timeframe" <?=$stat?> value="<?=$pa[0]->pa_timeframe?>"></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                                        ...
                                                        <?php 
                                                            foreach($detail_pa as $da){
                                                                ...
                                                                echo "<td><div class='input-group'>
                                                                        <input readonly type='number' min='0' max='100' class='form-control' value='".$progresstask."'>
                ...
                <div class="row pb-4">
                    <div class="card" style="width:100%">
                        ...
                        <div class="card-body text-center">
                            ...
                            //print_r($pa[0]);
                                 if($pa[0]->pa_file==""){
                                    echo "File belum diupload atau tidak sesuai format";
                                 }else{ 
                                ?>

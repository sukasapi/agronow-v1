...
class Learning_room extends CI_Controller {
    ...
    function index(){
        ...
        $data['page_name']          = 'Learning Room';
        $data['page_sub_name']      = 'List Learning Room';
        $data['is_content_header']  = TRUE;
        $data['page']               = 'learning_room/learning_room_list_view';
    ...
    function detail($content_id=NULL){
        ...
        $data['page'] = 'learning_room/learning_room_detail_view';
        $data['submenu'] = 'learning_room/learning_room_detail_submenu_view';
        $this->load->view('main_view',$data);
    }
    ...
    function create(){
        ...
        if(empty($url_return)){
            $url_return = site_url('learning_room');
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['form_action']    = site_url('learning_room/create');
            $data['page']           = 'learning_room/learning_room_form_create_view';
            ...
            if ($insert==TRUE) {
                $url_return = site_url('learning_room/detail/').$insert;
    ...
    function edit_content($content_id=NULL){
        ...
        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('learning_room/detail/').$content_id;
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('learning_room/edit_content').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Learning Room";
            $data['page_sub_name']      = 'Edit Konten'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'learning_room/learning_room_form_edit_content_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_publish($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('learning_room/edit_publish').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Learning Room";
            $data['page_sub_name']      = 'Edit Status'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'learning_room/learning_room_form_edit_publish_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_metadata($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('learning_room/edit_metadata').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Learning Room";
            $data['page_sub_name']      = 'Edit Metadata'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'learning_room/learning_room_form_edit_metadata_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function delete($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['request']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('learning_room/delete').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Learning Room";
            $data['page_sub_name']      = 'Hapus Learning Room';
            $data['page']               = 'learning_room/learning_room_form_delete_view';
            $this->load->view('main_view',$data);
        }else{
            ...
            if ($delete==TRUE) {
                ...
                $url_return = site_url('learning_room/delete/'.$content_id);

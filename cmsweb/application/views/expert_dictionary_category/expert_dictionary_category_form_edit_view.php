    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url("expert_dictionary_category"); ?>" class="btn kt-subheader__btn-primary">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    $get_cat_parent = $this->input->get('cat_parent');
                                    if ($this->input->get('cat_parent')){
                                        $val = $get_cat_parent;
                                    }

                                    $attr = 'class="form-control kt-input" id="input-asset-type"';
                                    echo form_dropdown('cat_parent', $form_opt_expert_dictionary_category, $val, $attr);

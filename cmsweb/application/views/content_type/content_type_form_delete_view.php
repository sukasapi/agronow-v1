                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <input type="hidden" name="content_type_id" value="<?php echo $request['content_type_id']; ?>" />

                            <div class="col-lg-6">

                                <p style="font-size:18px">Anda yakin ingin menghapus <b><?php echo $request['content_type_name']; ?></b>?</p>

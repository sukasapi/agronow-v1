                ...
                <div class="card shadow" style="border-radius:20px">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <ul class="nav card-header-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="one-tab" data-toggle="tab" href="#Tabwhislist" role="tab" aria-controls="One" aria-selected="true"><h4 style="color:#40739e">Wishlist</h4></a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link" id="three-tab" data-toggle="tab" href="#TabNoWishlist" role="tab" aria-controls="Three" aria-selected="false"><h4 style="color:#40739e">Belum Whislist</h4></a>
                                    </li>
                                </ul>  
                            </div>
                            <div class="col-md-4">
                                ...
                                <div id="menu3" class="float-right" hidden></div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        ...
                                                        foreach($whislist as $w){
                                                            ...
                                                            $stat = $w->status=="aktif"?"<span class='badge badge-pill badge-success'>aktif</span>":"<span class='badge badge-pill badge-danger'>dihapus</span>";
                                                            $str.="<tr>";
                                                            $str.="<td>".$no."</td>";
                                                            $str.="<td>".$w->entitas."</td>";
                                                            $str.="<td>".$w->NIP."</td>";
                                ...
                                <div class="tab-pane fade p-3" id="Tabapproval" role="tabpanel" aria-labelledby="two-tab">
                                ...
                                <div class="tab-pane fade p-3" id="TabNoWishlist" role="tabpanel" aria-labelledby="three-tab">
                                    <h5 class="card-title">Member Belum Menggunakan Wishlist</h5>
                                        <div class="table-responsive">
                                            <table class="table" id="tbNoWishlist" style="width:100%">
                                                 <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Nama</th>
                                                 ...
                                                 <tbody>
                                                    ...
                                                    $no=1;
                                                    $str="";
                                                        foreach($nowishlist as $nwl){
                                                            $str.="<tr>";
                                                            $str.="<td>".$no."</td>";
                                                            $str.="<td>".$nwl->nama."</td>";
                                                            $str.="<td>".$nwl->nip."</td>";
                                                            $str.="<td>".$nwl->entitas."</td>";
                                                            $str.="</tr>";
                                                            $no++;
                                                        }
                                                        echo $str;
...
<script>
    $(document).ready(function() {
            ...
            buttons: [
                    {
                        ...
                        titleAttr: 'Excel',
                        className: 'btn btn-success btn-rounded btn-md mr-2 btn-excel',
                        title: 'Daftar Member Belum Menggunakan Wishlist'
                    },
                    {
                        extend:    'pdf',
                        text:      '<i class="fas fa-file-pdf"></i>',
        ...
        Swal.fire({
            title: "Informasi !",
            text: "Data member yang ditampilkan pada summary adalah member dengan level karyawan 3 keatas (BOD-1,BOD-2,dan BOD-3)",
            icon: "information",

...
class Bod_share extends CI_Controller {
    ...
    function index(){
        ...
        $data['page_name']          = 'BOD Share';
        $data['page_sub_name']      = 'List BOD Share';
        $data['is_content_header']  = TRUE;
        $data['page']               = 'bod_share/bod_share_list_view';
    ...
    function detail($content_id=NULL){
        ...
        $data['page'] = 'bod_share/bod_share_detail_view';
        $data['submenu'] = 'bod_share/bod_share_detail_submenu_view';
        $this->load->view('main_view',$data);
    }

    function create(){
        has_access('bodshare.create');

        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('bod_share');
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['form_action']    = site_url('bod_share/create');
            $data['page']           = 'bod_share/bod_share_form_create_view';
            ...
            if ($insert==TRUE) {
                ...
                $url_return = site_url('bod_share/detail/').$insert;
    ...
    function edit_content($content_id=NULL){
        ...
        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('bod_share/detail/').$content_id;
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('bod_share/edit_content').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "BOD Share";
            $data['page_sub_name']      = 'Edit Konten'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'bod_share/bod_share_form_edit_content_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_picture($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('bod_share/edit_picture').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "BOD Share";
            $data['page_sub_name']      = 'Edit Gambar'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'bod_share/bod_share_form_edit_picture_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_publish($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('bod_share/edit_publish').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "BOD Share";
            $data['page_sub_name']      = 'Edit Status'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'bod_share/bod_share_form_edit_publish_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_metadata($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('bod_share/edit_metadata').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "BOD Share";
            $data['page_sub_name']      = 'Edit Metadata'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'bod_share/bod_share_form_edit_metadata_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function delete($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['request']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('bod_share/delete').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "BOD Share";
            $data['page_sub_name']      = 'Hapus BOD Share';
            $data['page']               = 'bod_share/bod_share_form_delete_view';
            $this->load->view('main_view',$data);
        }else{
            ...
            if ($delete==TRUE) {
                ...
                $url_return = site_url('bod_share/delete/'.$content_id);

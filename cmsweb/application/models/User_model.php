...
class User_model extends CI_Model {
    ...
    /* DATATABLE BEGIN */
    var $table = '_user';
    var $column_order = array('_user.user_id','_user.user_name','_user_level.user_level_name','_klien.nama','_group.group_name','_user.user_email','_user.user_create_date','_user.user_status'); //set column field database for datatable orderable
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->select('_user.*,_user_level.user_level_id,_user_level.user_level_name,_group.group_id,_group.group_name, _klien.nama as klien_nama');

        $this->db->from($this->table);

        $this->db->join('_klien', '_klien.id = _user.id_klien', 'left');
    ...
    function get_by_email($email,$except_email = NULL){
        ...
        if ($except_email){
            $this->db->where_not_in('user_email', array($except_email));
        }
    ...
    function login($email,$password){
        ...
        $this->db->where('user_email', $email);
        $this->db->where('user_password', md5(md5($password)));

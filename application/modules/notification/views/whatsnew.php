...
<div class="appHeader text-light" style="background: url('<?=PATH_ASSETS?>icon/login_bg.png'); background-repeat: no-repeat; background-size: 100%; border-top: 0px;">
    <div class="left">
        <a href="<?=base_url('notification')?>" class="headerButton">
        ...
        <nav>
            <ul class="pagination pagination-rounded">
                <?php if($data['prev_page'] > 0): ?>
                    <li class="page-item"><a class="page-link" href="<?=base_url("notification/whatsnew/".$data['prev_page'])?>">Previous</a></li>
                <?php endif ?>
                <?php if($data['next_page'] > 1): ?>
                    <li class="page-item"><a class="page-link" href="<?=base_url("notification/whatsnew/".$data['next_page'])?>">Next</a></li>
                <?php endif ?>
            </ul>
        </nav>
    </div>

...
class Kompetensi_jabatan_model extends CI_Model {
    ...
    function get($kompetensi_jabatan_id){
        ...
        $this->db->where('crm_id', $kompetensi_jabatan_id);
    ...
    function get_by_kompetensi_jabatan($cr_id,$jabatan_id){
        $this->db->select('_kompetensi_jabatan.*,_jabatan.jabatan_name,_group.group_name');
        $this->db->from('_kompetensi_jabatan');
    ...
    function insert($data){
        $this->db->insert('_kompetensi_jabatan', $data);
    ...
    function update($data){
        ...
        $this->db->update('_kompetensi_jabatan' ,$data);

        return $this->db->affected_rows() > 0 ? TRUE : FALSE;
    }

    function delete($kompetensi_jabatan_id){
        $this->db->where('crm_id',$kompetensi_jabatan_id);
        $this->db->delete('_kompetensi_jabatan');

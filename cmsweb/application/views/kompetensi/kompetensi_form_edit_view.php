                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <label class="mt-3">Panduan</label>
                                ...
                                <label class="mt-5">Prasyarat</label>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control date-picker" placeholder="dd/mm/yyyy" name="cr_date_start" value="<?php
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control date-picker" placeholder="dd/mm/yyyy" name="cr_date_end" value="<?php
                ...
                <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions kt-form__actions--solid">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <button type="submit" id="btn-save" class="btn btn-info pl-5 pr-5">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>

    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url("forum_group"); ?>" class="btn kt-subheader__btn-primary">
    ...
    <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
        <div class="row">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('forum_group/edit/'.$forum['forum_id']); ?>" class="btn btn-clean btn-sm  btn-icon-md <?= has_access("forumgroup.edit",FALSE)?"":"d-none" ?>">
                    ...
                    <div class="kt-portlet__body">
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <div>
                                    <?php echo $forum['forum_group_name']; ?>
                                </div>
                            </div>
                                        ...
                                        <?php foreach($comment as $v): ?>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <a href="<?= site_url('forum_group/remove_comment/').$v['fc_id'] ?>" title="Hapus" onclick="return confirm('Are you sure?')" class="text-danger <?= has_access("forumgroup.delete",FALSE)?"":"d-none" ?>"><i class="fa fa-trash-alt"></i> </a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 pt-3">
                                ...
                                <?= $forum['group_name'] ? '('.$forum['group_name'].')' : ''; ?>
                            </div>
                        </div>
                ...
                <div class="kt-portlet <?= has_access("forumgroup.delete",FALSE)?"":"d-none" ?>">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title text-primary">
                                Hapus Forum
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <center>
                                    <a href="<?php echo site_url('forum_group/delete/'.$forum['forum_id']); ?>" class="btn btn-danger btn-sm  btn-icon-md">

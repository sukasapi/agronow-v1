                    ...
                    <div class="kt-portlet__body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                $attr = 'class="form-control" id="select2_member" required multiple="multiple"';
                                echo form_dropdown('member_ids[]', $form_opt_member, $selected_value, $attr);
                        ...
                        <div class="kt-form__actions kt-form__actions--solid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?php echo site_url('classroom/member/').$classroom['cr_id']; ?>" class="btn btn-warning pull-right pl-5 pr-5">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>

    ...
    <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- CONTENT -->
                <?php $this->load->view('widget/content/portlet_create_content_digital_library_view', $data['request'] = isset($request)?$request:NULL); ?>

                <script>

                    $('#content_type_id').on('change', function (e) {
            ...
            <div class="col-lg-4">
                ...
                <!-- FILE -->
                <?php $this->load->view('widget/content/portlet_create_document_view', $data['request'] = isset($request)?$request:NULL); ?>

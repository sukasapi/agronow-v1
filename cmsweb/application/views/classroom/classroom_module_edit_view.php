                    ...
                    <div class="kt-portlet__body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                if (validation_errors()) {echo set_value('ModuleLinkZoom');}else{echo isset($request['ModuleLinkZoom']) ? htmlentities($request['ModuleLinkZoom'], ENT_QUOTES) : '';} ?>">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <?php
                                                    if(isset($request['Assignment'])) {
                                                        if($request['Assignment']=="ya"){
                                                            ?>
                                                                <input class="form-check-input" type="checkbox" id="is_assignment" checked name="is_assignment" value="ya">
                                                            <?php
                                                        }else{
                                                            ?>
                                     ...
                                     <div class="col-lg-12" id="text-assignment">
                                        ...
                                        <?php 
                                            $informasi=isset($request['InfoAssignment'])?$request['InfoAssignment']:"";
                                        ?>
                                        <textarea class="form-control" id="info_assignment" name="infoassignment"><?=$informasi?></textarea>
                                    </div>

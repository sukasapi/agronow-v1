    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url(''); ?>" class="btn kt-subheader__btn-primary">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <label class="mt-3">Password Saat Ini *</label>
                                <input type="password" class="form-control" placeholder="" name="password" required value="">

                                <label class="mt-3">Password Baru *</label>
                                <input type="password" class="form-control" placeholder="" name="password_new" required value="">

                                <label class="mt-3">Konfirmasi Password Baru *</label>
                                <input type="password" class="form-control" placeholder="" name="password_new_confirm" required value="">

...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <?php if(has_access('culturecat.create',FALSE)): ?>
            <a href="<?php echo site_url("culture_category/create/"); ?>" class="btn btn-brand kt-margin-l-10">
                Tambah
            </a>
            <?php endif; ?>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__body">
                        ...
                        <form action="<?php echo site_url('culture_category/update_tree'); ?>" method="post" accept-charset="utf-8">

                            <?php if(has_access('culturecat.edit',FALSE)): ?>
                                    ...
                                    <li id="menu-item-<?php echo $item['cat_id']; ?>" class="dd-item" data-id="<?php echo $item["cat_id"]; ?>">
                                        ...
                                        <p>
                                            ...
                                            <span class="dd-action">
                                                ...
                                                <?php endif; ?>
                                                <!--<a href="<?php /*echo site_url('culture_category/create').'?parent='.$item['cat_id']; */?>" title="add child" class=" <?/*= has_access("culturecat.create",FALSE)?"":"d-none" */?>">
                                                    <i class="fa fa-plus"></i>
                                                </a>-->
                                                <a href="<?php echo site_url('culture_category/edit/').$item['cat_id']; ?>" title="edit" class=" <?= has_access("culturecat.edit",FALSE)?"":"d-none" ?>">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a class="text-danger  <?= has_access("culturecat.delete",FALSE)?"":"d-none" ?>" href="<?php echo site_url('culture_category/delete/').$item['cat_id']; ?>" title="delete">

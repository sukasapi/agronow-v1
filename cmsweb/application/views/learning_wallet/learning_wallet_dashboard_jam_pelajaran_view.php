	  ...
	  <option>PTPN II</option>
		...
		<div class="kt-portlet">
			<div class="kt-portlet__body">
				<table>
					<tr>
						<td style="width:20%">Nama Entitas</td>
						<td>Total Jam Pembelajaran</td>
					</tr>
					<tr>
						<td>PTPN I</td>
						<td>XXX</td>
		...
		<div class="kt-portlet">
			<div class="kt-portlet__body">
				<table>
					<tr>
						<td style="width:20%">Level Karyawan</td>
						<td>Total Jam Pembelajaran</td>
					</tr>
					<tr>
						<td>BOD-1</td>
					...
					<table class="table table-bordered table-hover table-sm nowraps" id="kt_table">
						<thead>
							<tr>
								...
								<th class="text-center">Total Jam Pembelajaran</th>
							</tr>
						</thead>
					</table>
				</div>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table.DataTable({
                ...
                stateSave: false,
                ajax: {
                    url  : '<?php echo site_url('learning_wallet/l_ajax_jam_pelajaran').$_SERVER['QUERY_STRING']; ?>',
                    type : "POST"
                },
                language: {
                    "infoFiltered": ""

...
<head>
    ...
    <title>Agronow - Login Cucu Perusahaan</title>
...
<body style="background-color: black">
    ...
    <div id="appCapsule" class="pt-0 pb-0">
        ...
        <div class="login-form bg-white" style="height: 100vh">
            ...
            <?php endif ?>
                <form action="<?=base_url('login/auth?k=cucu')?>" method="POST">
                    ...
                    <div class="form-group mt-1">
                        <div class="text-right mt-1 mr-0">
                            <a href="<?= site_url('forgot?k=cucu'); ?>" class="text-muted">Forgot Password?</a>
                        </div>

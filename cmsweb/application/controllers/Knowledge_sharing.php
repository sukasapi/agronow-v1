...
class Knowledge_sharing extends CI_Controller {
    ...
    function index(){
        has_access('knowledgemanagement.view');
        ...
        $data['page_name']          = 'Knowledge Management';
        $data['page_sub_name']      = 'List Knowledge Management';
        $data['is_content_header']  = TRUE;
        $data['page']               = 'knowledge_sharing/knowledge_sharing_list_view';
    ...
    function detail($content_id=NULL){
        ...
        $data['page'] = 'knowledge_sharing/knowledge_sharing_detail_view';
        $data['submenu'] = 'knowledge_sharing/knowledge_sharing_detail_submenu_view';
        $this->load->view('main_view',$data);
    }

    function create(){
        has_access('knowledgemanagement.create');

        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('knowledge_sharing');
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['form_action']    = site_url('knowledge_sharing/create');
            $data['page']           = 'knowledge_sharing/knowledge_sharing_form_create_view';
            ...
            if ($insert==TRUE) {
                ...
                $url_return = site_url('knowledge_sharing/detail/').$insert;
    ...
    function edit_content($content_id=NULL){
        has_access('knowledgemanagement.edit');
        ...
        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('knowledge_sharing/detail/').$content_id;
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('knowledge_sharing/edit_content').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Knowledge Management";
            $data['page_sub_name']      = 'Edit Konten'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'knowledge_sharing/knowledge_sharing_form_edit_content_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_picture($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('knowledge_sharing/edit_picture').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Knowledge Management";
            $data['page_sub_name']      = 'Edit Gambar'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'knowledge_sharing/knowledge_sharing_form_edit_picture_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_publish($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('knowledge_sharing/edit_publish').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Knowledge Management";
            $data['page_sub_name']      = 'Edit Status'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'knowledge_sharing/knowledge_sharing_form_edit_publish_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_metadata($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('knowledge_sharing/edit_metadata').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Knowledge Management";
            $data['page_sub_name']      = 'Edit Metadata'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'knowledge_sharing/knowledge_sharing_form_edit_metadata_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function delete($content_id=NULL){
        has_access('knowledgemanagement.delete');
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['request']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('knowledge_sharing/delete').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Knowledge Management";
            $data['page_sub_name']      = 'Hapus Knowledge Management';
            $data['page']               = 'knowledge_sharing/knowledge_sharing_form_delete_view';
            $this->load->view('main_view',$data);
        }else{
            ...
            if ($delete==TRUE) {
                ...
                $url_return = site_url('knowledge_sharing/delete/'.$content_id);

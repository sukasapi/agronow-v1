                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Tambah Pertanyaan Feedback Modul
                            </h3>
                        </div>
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <!--<a href="<?php /*echo site_url('culture/member_add/'.$culture['cr_id']); */?>" class="btn btn-outline-light btn-sm  btn-icon-md">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="kt-radio-inline">
                            <label class="kt-radio kt-radio--solid">
                                ...
                                echo set_value('Type', $request['Type'] == 'pilihan' ? "" : "");
                                ?>> PILIHAN
                                <span></span>
                            </label>
                            <label class="kt-radio kt-radio--solid">
                        ...
                        <div class="kt-form__actions kt-form__actions--solid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?php echo site_url('culture/module_feedback/').$culture['cr_id'].'/'.$module_id; ?>" class="btn btn-warning pull-right pl-5 pr-5">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>

    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="<?php echo site_url("user/detail/").$request['user_id']; ?>" class="btn kt-subheader__btn-primary">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p style="font-size:18px">Anda yakin ingin menghapus <b><?php echo $request['user_name']; ?></b>?</p>

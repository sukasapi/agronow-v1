...
<div id="appCapsule">
    <div class="section full">
        ...
        <div class="p-2 mb-1">
			...
			<?php
			if($data['group_id']!=$data['id_group']) {
				echo '<div class="alert alert-danger mt-1"><b>Peringatan</b>: Saudara memiliki ID Group yang berbeda antara data pribadi dan data classroom (CRM:&nbsp;'.$data['crm_id'].'), mohon disampaikan kepada pengelola kelas.</div>';
			}
			?>
            ...
            if ($data['cr_has_project_assignment']): ?>
            <div class="mt-2">
                <?php
                   // $btn = 'btn-primary';
                   // $icon = 'fa fa-hourglass-2';
            ...
            <div class="mt-2">
                ...
                <a href="<?= $url; ?>" class="btn <?= $btn; ?> btn-block justify-content-between p-0 <?= $disabled; ?>">
                    ...
                    <!-- 26072024 | NPS feedback -->
                    <?php 
                        if(count((Array)$nps)){
                            $url=base_url('learning/evaluasi/nps_list/').$data['cr_id'];
                    ?>
                        <a href="<?= $url; ?>" class="btn btn-primary btn-block justify-content-between p-0">
                            <span class="btn-label btn-label-left float-left px-3 py-2 m-0">•</span>
                            <span class="p-0 m-0">NPS Feedback</span>
                            <span class="btn-label btn-label-right float-right px-3 py-2 m-0"><i class="<?= $icon ?>"></i></span>
                        </a>
                    <?php
                        }else{

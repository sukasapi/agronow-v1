                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo site_url('classroom/module_feedback_add/'.$classroom['cr_id'].'/'.$this->uri->segment(4)); ?>" class="btn btn-outline-info btn-sm  btn-icon-md <?= is_classroom_editable($classroom['cr_id'])?'':'d-none' ?>">
                            ...
                            <?php if(isset($request['Question'])): ?>
                                <?php foreach ($request['Question'] as $k => $v): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="<?= is_classroom_editable($classroom['cr_id'])?'':'d-none' ?>">												<a href="<?php echo site_url('classroom/module_feedback_edit/'.$classroom['cr_id']).'/'.$module_id.'/'.$k; ?>" class="btn btn-outline-info btn-sm ">
													Edit
												</a>

												<a href="<?php echo site_url('classroom/module_feedback_delete/'.$classroom['cr_id']).'/'.$module_id.'/'.$k; ?>" class="btn btn-outline-danger btn-sm btn-icon ml-2" onclick="return confirm('Anda yakin menghapus Pertanyaan?')" title="Hapus">

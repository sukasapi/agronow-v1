                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
									...
									<div class="col-lg-3">
                                        <label class="mt-4">Jam Mulai*</label>
								...
								<div class="row">
									...
									<div class="col-lg-3">
                                        <label class="mt-4">Jam Selesai*</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (validation_errors()) {echo set_value('TimeLimitMinute');}else{echo isset($request) ? htmlentities(explode(':',$request['TimeLimit'])[0], ENT_QUOTES) : '';} ?>">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (validation_errors()) {echo set_value('TimeLimitSecond');}else{echo isset($request) ? htmlentities(isset(explode(':',$request['TimeLimit'])[1])?explode(':',$request['TimeLimit'])[1]:'', ENT_QUOTES) : '';} ?>">
                                            <div class="input-group-prepend">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <small class="form-text text-muted">
                                            Kesempatan 1 kali berarti test hanya 1 kali, tidak dapat diulang.<br/>
											Opsi Tanpa Batas hanya bisa dipilih jika grade C dan grade D diisi nol.
                                        </small>
                                    </div>
...
/*                                            if (validation_errors()) {echo set_value('ReqPassed');}else{echo isset($request) ? htmlentities($request['ReqPassed'], ENT_QUOTES) : '';} */?>">
                                ...
                                <div class="row">
									...
									<small class="text-danger mt-1 ml-2">
										catatan:<br/>
										<ul>
											<li>peserta yang masuk kategori grade D dinyatakan gagal dan tidak mendapat sertifikat</li>
											<li>supaya semua peserta mendapat sertifikat isi grade C dan D menjadi nol.</li>
										</ul>
									</small>
                                </div>
                        ...
                        <div class="kt-form__actions kt-form__actions--solid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?php echo site_url('classroom/competency/').$classroom['cr_id']; ?>" class="btn btn-warning pull-right pl-5 pr-5">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <?php $no=0; foreach ($soal as $k => $v): ?>
                                        <tr id="soal-<?php echo $v['crs_id']; ?>">
                                            ...
                                            <td class="text-center">
                                                <a title="Remove" href="<?= site_url('classroom/competency_remove_soal/'.$classroom['cr_id'].'/'.$v['crs_id']); ?>" class="remove-soal btn text-danger <?= is_classroom_editable($classroom['cr_id'])?'':'d-none' ?>" onclick="return confirm('Anda yakin?')" data-classroom-id="<?= $classroom['cr_id']; ?>" data-soal-id="<?= $v['crs_id']; ?>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
...
<script>
    function addSelectedItem(selectedItems)
    {
        ...
        $.post("<?= site_url('classroom/competency_add_soal/'.$classroom['cr_id']); ?>", {crs_ids: ids}, function(result){

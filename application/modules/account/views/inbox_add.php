    ...
    <div id="appCapsule" class="demoPage">
        <div class="section full mt-2 mb-2 ml-2 mr-2">
            <div class="wide-block pt-2 pb-2">
                <form action="<?=base_url('account/inbox/add')?>" autocomplete="off" class="needs-validation" method="post" accept-charset="utf-8">
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="judul">Judul</label>
                            <input type="text" class="form-control" id="judul" name="inbox_title" placeholder="....." required>
                            <i class="clear-input">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <textarea id="address5" rows="2" class="form-control" name="inbox_desc" required></textarea>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                            <div class="valid-feedback">Looks good!</div>
                            <div class="invalid-feedback">Silahkan masukkan pesan</div>
                        </div>
                    </div>

...
class Announcement extends CI_Controller {
    ...
    function index(){
        ...
        $data['page_name']          = 'Pengumuman';
        $data['page_sub_name']      = 'List Pengumuman';
        $data['is_content_header']  = TRUE;
        $data['page']               = 'announcement/announcement_list_view';
    ...
    function detail($content_id=NULL){
        ...
        $data['page'] = 'announcement/announcement_detail_view';
        $data['submenu'] = 'announcement/announcement_detail_submenu_view';
        $this->load->view('main_view',$data);
    }

    function create(){
        has_access('announcement.create');

        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('announcement');
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['form_action']    = site_url('announcement/create');
            $data['page']           = 'announcement/announcement_form_create_view';
            ...
            if (isset($post['content_tags'])){
                ...
                $tags = NULL;
                $notif[] = 'Tag kosong atau belum diisi.';
            }
            ...
            if ($insert==TRUE) {
                ...
                $url_return = site_url('announcement/detail/').$insert;
    ...
    function edit_content($content_id=NULL){
        ...
        $url_return = $this->input->get('url_return');
        if(empty($url_return)){
            $url_return = site_url('announcement/detail/').$content_id;
        }
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('announcement/edit_content').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Pengumuman";
            $data['page_sub_name']      = 'Edit Konten'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'announcement/announcement_form_edit_content_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_picture($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('announcement/edit_picture').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Announcement";
            $data['page_sub_name']      = 'Edit Gambar'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'announcement/announcement_form_edit_picture_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_publish($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('announcement/edit_publish').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Pengumuman";
            $data['page_sub_name']      = 'Edit Status'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'announcement/announcement_form_edit_publish_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function edit_metadata($content_id=NULL){
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['content']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('announcement/edit_metadata').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Pengumuman";
            $data['page_sub_name']      = 'Edit Metadata'.'<br><small>'.$content['content_name'].'</small>';
            $data['page']               = 'announcement/announcement_form_edit_metadata_view';
            $this->load->view('main_view',$data);
        }else{
            $post = $this->input->post();
    ...
    function delete($content_id=NULL){
        has_access('announcement.delete');
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $data['request']            = $content;
            $data['url_return']         = $url_return;
            $data['form_action']        = site_url('announcement/delete').'/'.$content_id;
            $data['editable']           = TRUE;
            $data['page_name']          = "Pengumuman";
            $data['page_sub_name']      = 'Hapus Pengumuman';
            $data['page']               = 'announcement/announcement_form_delete_view';
            $this->load->view('main_view',$data);
        }else{
            ...
            if ($delete==TRUE) {
                ...
                $url_return = site_url('announcement/delete/'.$content_id);

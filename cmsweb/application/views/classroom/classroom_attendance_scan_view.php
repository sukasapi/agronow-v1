        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="alert alert-info fade show" role="alert">
                    ...
                    <div class="alert-text">						<ul>							<li>QR Code hanya muncul pada classroom berjenis <b>in class training</b></li>							<? /* cek fungsi attendance_scan_input_ajax() untuk jam terupdate */ ?>							<li>Presensi masuk: 00.00 sd 13.00</li>							<li>Presensi pulang: 13.01 sd 23.59</li>						</ul>					</div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <form id="formBarcode" action="<?= $form_action ?>" method="post">
                            <div class="form-group">
                                <input type="text" name="barcode" class="form-control" id="barcode" onmouseover="this.focus();">
                            </div>
                        </form>
...
<script>
    ...
    var table = $('#kt_table').DataTable({
        ...
        ajax: {
            url  : '<?php echo site_url('classroom/attendance_json'); ?>',
        },
        language: {
            "infoFiltered": ""
        },

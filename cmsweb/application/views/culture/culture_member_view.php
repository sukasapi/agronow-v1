                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <!--<a href="<?php /*echo site_url('culture/member_add/'.$culture['cr_id']); */?>" class="btn btn-clean btn-sm  btn-icon-md">
                                ...
                                <button data-backdrop="static"
                                        ...
                                        data-target="#cultureMemberPicker">Pilih Member
                                </button>

                                <!--begin::Modal-->
                                <div class="modal fade" id="cultureMemberPicker" tabindex="-1" role="dialog"
                                     aria-labelledby="cultureMemberPickerModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="cultureMemberPickerModalLabel">Member</h5>
                                ...
                                <?php $no=0; foreach ($member as $v): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Remove" href="<?= site_url('culture/member_remove/'.$culture['cr_id'].'/'.$v['crm_id']); ?>" class="btn text-danger" onclick="return confirm('Anda yakin?')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                <?php endif; ?>

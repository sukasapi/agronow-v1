                    ...
                    <div class="kt-portlet__body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <?php endif; ?>
                                <br><br>
                                <input type="file" class="form-control" name="Signature"  accept="image/png">
                                <small class="form-text text-muted">
                        ...
                        <div class="kt-form__actions kt-form__actions--solid">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?php echo site_url('classroom/certificate/').$classroom['cr_id']; ?>" class="btn btn-warning pull-right pl-5 pr-5">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>

                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
									...
									<label class="mt-3">Kode Silsilah:</label>
                                    <input type="text" class="form-control kt-input" placeholder="" name="silsilah" value="<?php
                                    if (validation_errors()) {echo set_value('silsilah');}else{echo isset($request) ? htmlentities($request['silsilah'], ENT_QUOTES) : '';} ?>">

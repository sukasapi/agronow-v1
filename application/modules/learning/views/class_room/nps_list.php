                               ...
                               <div class="card-footer text-muted mx-auto">
                                    <div class="text-center">
                                        <?php
                                            ...
                                            if($nd['jawab']==""){
                                                echo "<a class='btn btn-rounded ".$btn."' href='".base_url('learning/evaluasi/evaluasi_mulai/').$kode."'>Evaluasi</a>";    
                                            }else{
                                ...
                                <div class="card-body text-center">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-xs-12 text-center">
                                        <a href="<?=base_url('learning/class_room/home?cr_id='.$kelas)?>" class="btn btn-rounded btn-warning">Kembali</a>
                                    </div>
                                 </div>
                                </div>
                            </div>
